 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Logan Allen");
		  toPrint += p1.toString("lallen35");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Will Thompson");
		  toPrint += p2.toString("wthompson40");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Estella Dieci");
		  toPrint += p3.toString("edieci6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Mitch Myers");
                  toPrint += p4.toString("mmyers39");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Jeremy Paul");
                  toPrint += p5.toString("jpaul33");
